...
let Calls = {
  ...
  listCats(dtoIn) {
    let commandUri = Calls.getCommandUri("cat/list");
    return Calls.call("get", commandUri, dtoIn);
  },
  getCat(dtoIn) {
    let commandUri = Calls.getCommandUri("cat/get");
    return Calls.call("get", commandUri, dtoIn);
  },
  createCat(dtoIn) {
    let commandUri = Calls.getCommandUri("cat/create");
    return Calls.call("post", commandUri, dtoIn);
  },
  updateCat(dtoIn) {
    let commandUri = Calls.getCommandUri("cat/update");
    return Calls.call("post", commandUri, dtoIn);
  },
  deleteCat(dtoIn) {
    let commandUri = Calls.getCommandUri("cat/delete");
    return Calls.call("post", commandUri, dtoIn);
  },
  loadCatInstance(dtoIn) {
    let commandUri = Calls.getCommandUri("CatInstance/load");
    return Calls.call("get", commandUri, dtoIn);
  },
